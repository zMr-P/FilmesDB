## ContextoDB
Responsabilidade de um banco de dados de um site de filmes, onde são armazenados dados sobre os filmes e seus atores. Solicitado para que realize uma consulta no banco de dados com o objetivo de trazer alguns dados para análises.

## Proposta
Realização de 12 consultas ao banco de dados, cada uma retornando um tipo de informação.
Banco de dados modelado da seguinte maneira:
